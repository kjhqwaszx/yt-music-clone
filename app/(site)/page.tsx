import Category from "@/app/(site)/components/Category.tsx";
  ...
  return (
    <PagePadding>
      <div className="min-h-[600px]">
        ...
        <PlayListCarousel playlistArray={[...dummyPlaylistArray1]} Thumbnail={<div><UserIcon size="lg"/></div>} title="다시 듣기" subTitle="도도"/>
